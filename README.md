...
| 이름 | 역할 | 담당 |
| --- | --- | --- |
| 변혁진 | 팀장 | 프로젝트 총괄 · 일정 관리 · 요구사항 조율 |
| 박상윤 | 클라우드 · CI/CD | Docker · AWS EC2 배포 · GitLab 파이프라인 · UI 개선 |
| 손유빈 | Frontend | 키오스크 주문 화면 |
| 이용욱 | Backend | 본사 관리 기능 |
| 최소현 | Backend | 지점 관리 기능 |
| 전예원 | DB · 통계 | DB 설계 · 매출 통계 |
