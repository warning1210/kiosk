...
CREATE TABLE `event` (
  ...
  `event_type` ENUM ('MONTHLY_FLAVOR', 'SIZE_UP', 'AMOUNT_DISCOUNT', 'COUPON', 'NEW_PRODUCT', 'STOCK_CLEARANCE') NOT NULL,
  `benefit_type` ENUM ('DISCOUNT_RATE', 'DISCOUNT_AMOUNT', 'SIZE_UP', 'COUPON', 'NONE') NOT NULL DEFAULT 'NONE',
  `image_url` varchar(500),
  `description` text,
