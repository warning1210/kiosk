...
public interface AuditLogRepository {
    ...
    @Results(id="auditMap",value={@Result(column="audit_log_id",property="auditLogId",id=true),@Result(column="entity_type",property="entityType"),@Result(column="entity_id",property="entityId"),@Result(column="action",property="action"),@Result(column="field_name",property="fieldName"),@Result(column="old_value",property="oldValue"),@Result(column="new_value",property="newValue"),@Result(column="reason",property="reason"),@Result(column="changed_at",property="changedAt"),@Result(column="admin_id",property="admin",javaType=Admin.class,one=@One(select="com.kiosk.domain.admin.AdminRepository.findById"))})
