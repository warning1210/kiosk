<template>
  <aside class="sidebar">
    ...
    <nav>
      ...
      <RouterLink :class="{ active: active === 'stock-requests' }" to="/branch/stock-requests"><i>♧</i>입고 신청 현황</RouterLink><a href="#"><i>□</i>이벤트 관리</a><RouterLink :class="{ active: active === 'sales' }" to="/branch/sales"><i>⌁</i>판매 통계</RouterLink><RouterLink :class="{ active: active === 'chat' }" to="/branch/chat"><i>✉</i>본점 채팅</RouterLink>
    </nav>
